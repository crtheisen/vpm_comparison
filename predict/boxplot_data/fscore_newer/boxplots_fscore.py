...
files = ['crashesst_fscore.csv','scandariatost_fscore.csv','shinst_fscore.csv','zimmermannst_fscore.csv','scandariato_crashesst_fscore.csv','softwaremetrics_crashesst_fscore.csv','textmining_softwaremetricsst_fscore.csv','everythingst_fscore.csv']
