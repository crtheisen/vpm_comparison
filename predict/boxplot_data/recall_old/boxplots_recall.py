...
files = ['crashes_recall.csv','scandariatost_recall.csv','shinst_recall.csv','zimmermannst_recall.csv','scandariato_crashesst_recall.csv','softwaremetrics_crashes_recall.csv','textmining_softwaremetricsst_recall.csv','everythingst_recall.csv']
